...
learning_rate = 0.008
num_epochs = 100
save_model_prefix = dir_base+'models/cntk_bilstm_'
training_log_file = dir_base+'train_cntk_bilstm.log'
rnn_model = rnn.CNTK_BiLSTM(n_in=n_ins, n_out=n_outs, init_lr=learning_rate, momentum=0.5)
