...
ctx = mx.gpu()
net = rnn.MXNET_BiGRU(num_out=n_outs, num_hidden=512)
net.initialize(ctx=ctx, init=init.Xavier())
net.hybridize()
save_model_prefix = dir_base+'models/mxnet_bigru_'
training_log_file = dir_base+'train_mxnet_bigru.log'
if fine_tune:
