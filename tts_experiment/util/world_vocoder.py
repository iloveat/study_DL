...
sptk_dir = '/home/brycezou/DATA/Audio/merlin_extractor/tools/bin/SPTK-3.9/'
world_dir = '/home/brycezou/DATA/Audio/merlin_extractor/tools/bin/WORLD/'
...
def generate_wave(output_dir, file_id_list, b_16k=True):
    if b_16k:  # 16k
        fw_coef = 0.58
        fw_alpha = 0.58
        sr = 16000
    ...
    for filename in file_id_list:
        ...
        print 'wrote to wave %s' % filename
